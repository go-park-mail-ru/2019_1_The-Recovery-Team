...
func easyjson4086215fDecodeGithubComGoParkMailRu20191TheRecoveryTeamInternalAppDomainChat(in *jlexer.Lexer, out *MessageInfo) {
...
func easyjson4086215fEncodeGithubComGoParkMailRu20191TheRecoveryTeamInternalAppDomainChat(out *jwriter.Writer, in MessageInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson4086215fDecodeGithubComGoParkMailRu20191TheRecoveryTeamInternalAppDomainChat1(in *jlexer.Lexer, out *Message) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4086215fEncodeGithubComGoParkMailRu20191TheRecoveryTeamInternalAppDomainChat1(out *jwriter.Writer, in Message) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson4086215fDecodeGithubComGoParkMailRu20191TheRecoveryTeamInternalAppDomainChat2(in *jlexer.Lexer, out *Data) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4086215fEncodeGithubComGoParkMailRu20191TheRecoveryTeamInternalAppDomainChat2(out *jwriter.Writer, in Data) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Data) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4086215fEncodeGithubComGoParkMailRu20191TheRecoveryTeamInternalAppDomainChat2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Data) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4086215fDecodeGithubComGoParkMailRu20191TheRecoveryTeamInternalAppDomainChat2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Data) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4086215fDecodeGithubComGoParkMailRu20191TheRecoveryTeamInternalAppDomainChat2(l, v)
}
